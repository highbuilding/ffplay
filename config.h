...
#define FFMPEG_CONFIGURATION "--pkg-config-flags=--static --extra-cflags=-I/usr/local/Cellar/ffmpeg/4.3.1/include --extra-ldflags=-L/usr/local/Cellar/ffmpeg/4.3.1/lib --extra-libs='-lpthread -lm' --disable-yasm --enable-gpl --enable-libfdk-aac --enable-libmp3lame --enable-libtheora --enable-libvorbis --enable-libx264 --enable-nonfree --disable-optimizations --enable-debug --enable-shared --enable-static --disable-stripping --enable-pic"
